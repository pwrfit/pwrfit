                        ...
                        <div class="card-body">
                            <form action="{{ route('categorias.store') }}" method="POST">
                                ...
                                <div class="form-group" style="padding-top: 10px;">
                                    <label for="nombrecat">Icono de la categoria <a href="https://fontawesome.com/search?s=solid%2Cbrands" target="_blank" rel="noopener noreferrer">Referencia</a></label>
